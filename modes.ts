...
visible in the scene (with representative emojis).`,
  ...
  'Text Extraction': {
    emoji: '🔤',
    prompt: `Act as a precise data extraction tool. ONLY extract the following information for each product shown in the video: 
1. Product Name (e.g., Quicken)
2. Star Rating (e.g., 4.8)
3. Number of reviews
4. The list of Accounting features and the checkmark status next to them (use 'v' for checkmark/included and 'x' for cross/not included).

For each product identified, call set_timecodes with the timecode it appears and the text formatted exactly as follows: 
"[Product Name] | Rating: [Rating] ([Reviews] reviews) | Features: [Feature 1] (v), [Feature 2] (x), [Feature 3] (v)..."`,
    isList: true,
  },
